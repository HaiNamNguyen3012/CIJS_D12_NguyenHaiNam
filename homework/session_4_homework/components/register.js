...
class Register{
    ...
    constructor(){
        ...
        this.$container.classList.add('container','register');
    ...
    render(){
        ...
        this.$container_child.appendChild(this.$feedbackMessage);
        this.$container_child.appendChild(this.$formRegister);
        this.$container_child.appendChild(this.$linkToLogin);
